...
Movie_Poster:"https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/078277ed-5380-4deb-b166-997beba79634/dd9d7mn-f61245cb-266b-469d-8433-061d911c5005.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..qiixeWj8ZLhL9gZlSwWga9m7DxrI1FUOxxGlCUnnysg",
Rating:8.5,
...
{
    Movie_Name:"Aladdin",
    Movie_Poster:"https://tse3.mm.bing.net/th?id=OIP.MPoPZc3_hLlHqKcrmZ9u1AHaLH&pid=Api&P=0&w=300&h=300",
    Rating:6.9,
    ...
    },
    {
        ...
        Movie_Poster:"http://www.cultjer.com/img/ug_photo/2015_09/32772420150915154419.jpg",
        Rating:8.3,
        ...
        {
            Movie_Name:"Mulan",
            Movie_Poster:"https://tse1.mm.bing.net/th?id=OIP.cSfAqOGAaItXT97UtEeTrgHaK9&pid=Api&P=0&w=300&h=300",
            Rating:5.7,
        ...
        {
                Movie_Name:"Frozen",
                Movie_Poster:"https://tse4.mm.bing.net/th?id=OIP.iH0GOTPm9S2O4Dwivr44cgHaHa&pid=Api&P=0&w=300&h=300",
                Rating:7.4,
        ...
        },
        {
                    ...
                    Movie_Poster:"https://fanart.tv/fanart/movies/9325/movieposter/the-jungle-book-523470dda735e.jpg",
                    Rating:7.6,
        ...
        <div className="App">
        {movies.map((ur)=>(
        <Msg name={ur.Movie_Name} pic={ur.Movie_Poster} Rate={ur.Rating} summary={ur.Summary}/>
        ))}
        </div>
        );
        }
        
        function Msg({name,pic,Rate,summary}){
        return(
        <div>
        <img className="movie-pic" src={pic} alt={name}/>
        <h1 className="movie-name">Movie Name: {name}</h1>
        <h1 className="movie-rating">🤩Rating: {Rate}</h1>
        <h1 className="movie-summary"><b>Summary:</b>{summary}</h1>
        <p>**************************************************************************</p>
        </div>
        );
        }
